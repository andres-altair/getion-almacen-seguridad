...
<head>
    ...
    <style>
        ...
        .navbar .nav-link:hover {
         ...
         /* Estilo específico para el enlace de "Gestión de Usuarios" */
        .navbar .nav-link.usuarios {
            color: var(--amarillo-oscuro); /* Color amarillo oscuro */
        }

        .navbar .nav-link.usuarios:hover {
            color: var(--amarillo-oscuro); /* Mantener el color al pasar el ratón */
        }
        ...
        .btn.admin{
        background-color: var(--gris-oscuro); /* Fondo azul marino al pasar el ratón */
            color: var(--blanco); /* Texto blanco al pasar el ratón */
        }
